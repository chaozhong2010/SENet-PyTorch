...
def train_model(args, model, criterion, optimizer, scheduler, num_epochs, dataset_sizes):
    ...
    for epoch in range(args.start_epoch+1,num_epochs):
        ...
        if (epoch+1) % args.save_epoch_freq == 0:
            ...
            torch.save(model, os.path.join(args.save_path, "epoch_" + str(epoch) + ".pth"))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--num-class', type=int, default=45)
    ...
    parser.add_argument('--save-path', type=str, default="output-resnext")
